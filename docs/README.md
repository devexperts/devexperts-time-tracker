...
_Note:_ you can change duration of the ticket only after stopping time tracking of this ticket. The worklogs cannot intersect.
...
_Note:_ You can add the ticket to the timeline in the future and continue a real time tracking. But real time tracking of a current ticket will stop once it reaches the start time of that ticket. 
...
In the zoomed view, the hours will be highlighted, with a blue box. **To exit the short worklog zoomed view** click on the blue box.
